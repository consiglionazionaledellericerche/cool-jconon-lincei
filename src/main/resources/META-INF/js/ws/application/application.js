    ...
    bulkinfo =  new BulkInfo({
      ...
      callback: {
        beforeCreateElement: function (item) {
          ...
          if (item.name === 'application_elenco_discipline_umanistiche') {
            var jsonlist = [];
            if (call["jconon_lincei_materie:call_elenco_discipline_umanistiche"]) {
              $.each(call["jconon_lincei_materie:call_elenco_discipline_umanistiche"], function (index, el) {
                jsonlist.push({
                  "key" : el,
                  "label" : el,
                  "defaultLabel" : el
